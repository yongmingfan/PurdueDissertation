...
Our design choices mean that is easy to extend \snarkprobe to support new languages and libraries, without needing to investigate new instrumentation techniques or tools.
