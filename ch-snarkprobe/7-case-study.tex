...
We summarize our results in \autoref{tab:snarkprobe-error_summary}.%, including the type of error, which component of \tool is able to detect the error, and what exactly the error affects.
