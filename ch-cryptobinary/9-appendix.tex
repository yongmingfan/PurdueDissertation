\section{List of Optimizations, Obfuscations, and their Combinations for Our Evaluation Metrics}
\label{app:cryptobinary-metrics}
\begin{enumerate}
\setcounter{enumi}{-1}
\item No identification
\item Identification with optimization flag -O0
\item Identification with optimization  flag -O1
\item Identification with optimization flag -O2
\item Identification with optimization flag -O3
\item Identification with optimization  flag –Os
\item Identification with optimization flag: -Ofast
\item Identification with instruction substitution obfuscation: -obs\textunderscore sub
\item Identification with control-flow flattening: -obs\textunderscore fla
\item Identification with bogus control-flow: -obs\textunderscore bcf
\item Identification with combination of obfuscation: -obs\textunderscore sub, obs\textunderscore fla, obs\textunderscore bcf
\item Identification with combination of obfuscation and optimization: -obs\textunderscore sub, obs\textunderscore fla, obs\textunderscore bcf, -O3
\end{enumerate}
...
\label{app:cryptobinary-addltables}
%\input{tab_comparativestudy}

This appendix contains the complete results of all of our replication and reproduction studies.

\input{ch-cryptobinary/tab_percentages}
\input{ch-cryptobinary/tab_detection}
%\input{tab_evaluation}
\input{ch-cryptobinary/tab_fullevaluation}
%\input{tab_fullevaluation_old}