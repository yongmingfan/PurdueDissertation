...
To ensure a thorough exploration of current tools (and to provide rigorous and fair evaluation metrics for the future), we have meticulously crafted a series of evaluation experiments. These experiments are thoughtfully designed to align with the challenges we discuss in Section \ref{subsec:cryptobinary-challenges}, maximizing our ability to uncover the current state of these tools and elucidate their strengths and weaknesses.  Our evaluation metrics are as follows:
 
\begin{itemize}
\item \textbf{Based on optimization levels:} Evaluate based on different compiler optimizations including -O0, -O1, -O2, -O3, -Os, and -Ofast
...
\item \textbf{Combination of all prior techniques}
\end{itemize}
...
The full list of optimizations, obfuscations, and their combinations we select for our evaluation can be found in Appendix \ref{app:cryptobinary-metrics}.
