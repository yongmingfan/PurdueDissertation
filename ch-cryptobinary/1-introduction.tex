...
asked to pay ransom in exchange for recovering their files and information.
...
In \autoref{sec:cryptobinary-background}, we provide background on cryptographic function detection, and in \autoref{sec:cryptobinary-overview}, we introduce existing cryptographic algorithm detection tools. In \autoref{sec:cryptobinary-framework}, we present our newly developed benchmarking framework and evaluation metrics for reproduction and replication studies. In \autoref{sec:cryptobinary-reproduction} and \autoref{sec:cryptobinary-replication}, we report the evaluation results for both reproduction and replication studies and identify future research directions based on these findings. Finally, in \autoref{sec:cryptobinary-discussion}, we discuss broader research opportunities and key areas for future improvement.
