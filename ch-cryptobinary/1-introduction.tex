...
\begin{figure}[t]
  \includegraphics[width=\linewidth,keepaspectratio]{ch-cryptobinary/figure/Crypto_timeline.png}
	\vspace*{-20pt}
...
\parhead{Our contributions.} Our primary contributions are:
...
%\parhead{Outline.} The outline of our paper is as follows.
...
%\clg{This needs to be updated once we tighten the paper flow.}
