...
\\
  Zero Knwoledge Proof & A cryptographic protocol that allows a user (the prover) proves a statement to another party (the veriﬁer) without revealing anything about the statement other than that it is true.
\\
